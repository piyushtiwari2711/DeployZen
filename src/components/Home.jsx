...
const Home = () => {
  ...
  const projects = [
    ...
    },
    {
      title: "CoFlow",
      description:
        "A collaborative workflow management tool designed to streamline team projects and boost productivity.",
      image:
      ...
      <section id="contact" className="relative z-10 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Ready to transform your deployment process? Let's talk about how
              we can help
            </p>
          </div>
